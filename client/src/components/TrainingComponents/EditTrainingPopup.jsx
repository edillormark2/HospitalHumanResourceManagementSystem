...
const EditTrainingPopup = props => {
  ...
  const [trainer, setTrainer] = useState("Dr. Samantha Reyes");
  const [trainingType, setTrainingType] = useState("Job Training");
  ...
  const [description, setDescription] = useState(
    "Currently learing the basic clinical guidelines"
  );
    ...
    <div>
      <Modal open={openPopup}>
        ...
        >
          ...
          <CardTitle title="Edit Employee Training" />
          <Divider />
          ...
          <div className="mt-5 mb-5">
            <p className="mb-1 text-sm">Progress Status</p>
            <ProgressBar
              width="100%"
              height="8px"
              progress="70%"
